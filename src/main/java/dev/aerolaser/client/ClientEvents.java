...
public class ClientEvents {
    ...
    public static void onRegisterRenderers(EntityRenderersEvent.RegisterRenderers event) {
        boolean veil = ModList.get().isLoaded("veil");
        event.registerBlockEntityRenderer(AeroLaserBlockEntities.SHOW_LASER.get(), veil ? VeilLaserRenderer::new : ShowLaserRenderer::new);
